...
1. Place [`Hyperlib_v1_5.py`](Versions/Hyperlib_V1_5/Hyperlib_v1_5.py) and [`main_program.py`](Versions/Hyperlib_V1_5/main_program.py) in the same directory on your SPIKE Prime hub.
...
#### [`MoveMM(Distance, MaxSpeed, MinSpeed, Forward, Stopping)`](Versions/Hyperlib_V1_5/Hyperlib_v1_5.py#L194)
...
#### [`MoveGyro(Distance, Theta, MinSpeed, MaxSpeed, Forward, Stopping)`](Versions/Hyperlib_V1_5/Hyperlib_v1_5.py#L492)
...
#### [`TurnGyro(Theta, MaxSpeed, MinSpeed, EarlyExit, Forward, Direction, Stopping)`](Versions/Hyperlib_V1_5/Hyperlib_v1_5.py#L538)
...
#### [`TurnMM(turn_mm, MaxSpeed, MinSpeed, EarlyExit, Stopping)`](Versions/Hyperlib_V1_5/Hyperlib_v1_5.py#L251)
...
#### [`TurnToPoint(TargetX, TargetY, MaxSpeed, MinSpeed, EarlyExit, Forward, Direction, Stopping)`](Versions/Hyperlib_V1_5/Hyperlib_v1_5.py#L593)
...
#### [`SwingGyro(Side, Theta, EarlyExit, MaxSpeed, MinSpeed, Forward, Direction, Stopping)`](Versions/Hyperlib_V1_5/Hyperlib_v1_5.py#L410) 
...
#### [`SwingMM(Side, turn_mm, EarlyExit, MaxSpeed, MinSpeed, Direction, Stopping)`](Versions/Hyperlib_V1_5/Hyperlib_v1_5.py#L322)
...
#### [`SwingToPoint(Side, TargetX, TargetY, EarlyExit, MaxSpeed, MinSpeed, Forward, Direction, Stopping)`](Versions/Hyperlib_V1_5/Hyperlib_v1_5.py#L652)
...
#### [`MoveToPoint(targetX, targetY, MaxSpeed, MinSpeed, ArrivalThreshold, Forward, Stopping)`](Versions/Hyperlib_V1_5/Hyperlib_v1_5.py#L733)
...
#### [`MoveToPoRo(targetX, targetY, targetAngle, offsetDistance, finalDistance, offsetAngle, MaxSpeed, MinSpeed, ArrivalThreshold, minRatio, Forward, DKp, Stopping)`](Versions/Hyperlib_V1_5/Hyperlib_v1_5.py#L789)
...
#### [`Stop()`](Versions/Hyperlib_V1_5/Hyperlib_v1_5.py#L886)
Brakes both motors for 40 ms, then holds them in place.

#### [`DegToMM(deg)`](Versions/Hyperlib_V1_5/Hyperlib_v1_5.py#L53)
Converts motor encoder degrees to millimeters of travel using the configured wheel diameter.

#### [`ThetaErr(angle)`](Versions/Hyperlib_V1_5/Hyperlib_v1_5.py#L58)
...
- **⚠️ First run:** Before running any program, update your robot's physical specs at the top of [`Hyperlib_v1_5.py`](Versions/Hyperlib_V1_5/Hyperlib_v1_5.py#L33) to match your actual hardware:
  ```python
...
| Version | File | Notes |
|---------|------|-------|
| v1.5 | [`Hyperlib_v1_5.py`](Versions/Hyperlib_V1_5/Hyperlib_v1_5.py) | Added arc odometry, encoder-based turns (`TurnMM`, `SwingMM`), improved PID gains |
| v1.4 | [`Hyperlib_V1_4/`](Versions/Hyperlib_V1_4/) | Previous stable version |
| v1.3 | [`Hyperlib V1.3.py`](Hyperlib%20V1.3.py) | Initial release |
